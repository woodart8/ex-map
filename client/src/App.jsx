...
import Promotion2Page from './pages/Promotion2Page'
    ...
    <div className="App">
      <div>
        <Routes>
          ...
          <Route path='/promotion/:ex_id' element={<Promotion2Page {...loginUserProps} />} />
          ...
          <Route path='/review/post' element={<ReviewEditorPage {...loginUserProps} />} />
